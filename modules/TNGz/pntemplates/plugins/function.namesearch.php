...
function smarty_function_namesearch($params, &$smarty)
{
    ...
    $output .= "<h2>" . _TNGZ_NAMESEARCH_SEARCH . "</font></h2>\n";
    ...
    $output .= "<tr><td><span class=\"normal\"><a href=\"" .pnModURL('TNGz','user','main', array('show'=>'searchform')) . "\">" . _TNGZ_NAMESEARCH_ADVANCED . "</a>\n";
    $output .= "</table></form>\n";
    $output .= "</div>\n";
