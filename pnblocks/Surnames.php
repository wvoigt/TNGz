...
function TNGz_Surnamesblock_display($blockinfo)
{
    ...
    $blockinfo['content'] = $pnRender->fetch('TNGz_block_Surnames.htm');
...
function TNGz_Surnamesblock_modify($blockinfo)
{
    ...
    $pnRender->assign('stypelist', array( 'cloud' => pnVarPrepHTMLDisplay(_TNGZ_CLOUD),
                                          'table' => pnVarPrepHTMLDisplay(_TNGZ_TABLE),
    ...
    return $pnRender->fetch('TNGz_block_Surnames_modify.htm');
}
