...
function TNGz_Placesblock_display($blockinfo)
{
    ...
    $blockinfo['content'] = $render->fetch('TNGz_block_Places.htm');
...
function TNGz_Placesblock_modify($blockinfo)
{
    ...
    $render->assign('stypelist', array( 'table' => pnVarPrepHTMLDisplay(__('Table', $dom)),
    ...
    return $render->fetch('TNGz_block_Places_modify.htm');
}
